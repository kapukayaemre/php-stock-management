...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= SITE_URL; ?>"><b>STOK TAKİP</b><br><i style="font-size: 25px;">Giriş Ekranı</i></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <?php if (isset($_SESSION['statu'])) : ?>
                <p class="login-box-msg alert "><?= $_SESSION['statu']; ?></p>
            <?php endif; ?>
    ...
    <!-- iCheck -->
    <script src=".<?= PLUGIN_PATH; ?>/icheck.min.js"></script>
    <script>
        $(function() {
            $('input').iCheck({
